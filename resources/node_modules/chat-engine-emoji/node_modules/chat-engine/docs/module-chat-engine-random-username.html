...
<head>
    ...
    <title>chat-engine-random-username - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-random-username</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Update a <a href="Me.html">Me</a>'s state in a <a href="Chat.html">Chat</a> by randomly combining a color and an animal. Ex: &quot;teal_seal&quot;</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-random-username_src_plugin.js.html">chat-engine-random-username/src/plugin.js</a>, <a href="chat-engine-random-username_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="module:chat-engine-random-username">

    <span class="type-signature"></span>require('chat-engine-random-username')<span class="signature">(chat)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-random-username_src_plugin.js.html">chat-engine-random-username/src/plugin.js</a>, <a href="chat-engine-random-username_src_plugin.js.html#line22">line 22</a>
    </li></ul></dd>
...
<span class="param-type"><a href="Chat.html">Chat</a></span>
            ...
            <td class="description last"><p>The <a href="Chat.html">Chat</a> to add the username to. Most likely will be <code>global</code> chat.</p></td>
        </tr>
...
<h4 class="name" id="~state()%22.%22username">

<span class="type-signature">(inner) </span>state().username<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-random-username_src_plugin.js.html">chat-engine-random-username/src/plugin.js</a>, <a href="chat-engine-random-username_src_plugin.js.html#line30">line 30</a>
    </li></ul></dd>
