...
<head>
    ...
    <title>React Web - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">React Web</h1>
...
<article>
    <script src="//gist-it.appspot.com/github/pubnub/chat-engine-examples/blob/master/react/src/index.js?footer=0"></script>
</article>
