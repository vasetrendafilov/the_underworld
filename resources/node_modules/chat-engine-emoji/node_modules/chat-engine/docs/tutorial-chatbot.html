...
<head>
    ...
    <title>NodeJS Chat Bot - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">NodeJS Chat Bot</h1>
...
<header>
    ...
    <!-- <h2>NodeJS Chat Bot</h2> -->
</header>

<article>
    <script src="//gist-it.appspot.com/github/pubnub/chat-engine-examples/blob/master/nodejs/bot.js?footer=0"></script>
</article>
